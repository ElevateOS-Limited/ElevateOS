...
export const BILLING_PLANS = [
  {
    id: 'FREE',
    name: 'Free',
    description: 'A light starter plan for trying the free student dashboard and keeping a simple weekly rhythm.',
    monthlyPrice: 0,
    yearlyPrice: 0,
    features: ['Freemium AI onboarding', 'Basic worksheet generation', 'Product chatbot', 'Shared demo dashboard'],
  ...
  },
  {
    id: 'PRO',
    name: 'AI Premium',
    description: 'The core plan for students who need stronger AI support, structured study tools, and cleaner progress tracking.',
    monthlyPrice: 19,
    yearlyPrice: 149,
    badge: 'Most popular',
    featured: true,
  ...
  },
  {
    ...
    description: 'For families, tutors, and higher-touch support that need weekly planning and parent visibility.',
    monthlyPrice: 39,
    yearlyPrice: 390,
