...
const QUICKSTART_STATE_KEY = 'elevateos.quickstart.state.v1'
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-6 sm:px-6 space-y-6 overflow-x-hidden">
      <div className="space-y-2">
        <h1 className="text-2xl sm:text-3xl font-bold">Tutor setup</h1>
        <p className="text-sm sm:text-base text-gray-500">Try the class list, worksheet generation, score tracking, and report history in one place.</p>
        <p className="text-xs text-gray-500">
          Data source: {sourceMode === 'profile' ? 'Live classes' : 'Fallback demo classes'}
        </p>
      </div>
